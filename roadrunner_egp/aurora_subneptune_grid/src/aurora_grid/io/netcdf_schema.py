...
def _grid_params(row: dict[str, Any], model_output: dict[str, Any], wavelength_um: np.ndarray) -> dict[str, Any]:
    return {
        ...
        "wavelength_grid_mode": str(row.get("wavelength_grid_mode", "")),
        "configured_wavelength_min_um": _float_row_value(row, "wavelength_min_um", float(np.nanmin(wavelength_um))),
        "configured_wavelength_max_um": _float_row_value(row, "wavelength_max_um", float(np.nanmax(wavelength_um))),
        "configured_wavelength_resolution": _float_row_value(row, "wavelength_resolution", float("nan")),
        "configured_wavelength_points": int(_float_row_value(row, "wavelength_points", wavelength_um.size)),
