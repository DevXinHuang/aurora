#!/usr/bin/env python
"""Write one Cahoy 2010 spectrum NetCDF from a cached climate PT profile."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Spectrum stage for one Cahoy manifest row.")
...
def main() -> int:
    ...
    print(f"cahoy_reference_name: {row.get('cahoy_reference_name')}")
